...
const Dropdown = ({ isOpen, toggleDropdown, onSelect, status }: DropdownProps) => {
    const [selected, setSelected] = useState<string>(status? status : '');
